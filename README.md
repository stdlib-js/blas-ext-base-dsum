...
```javascript
dsum = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsum@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsum@umd/bundle.js"></script>
```
