...
```javascript
dsum = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dsum@v0.0.9-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dsum/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/blas-ext-base-dsum/actions/workflows/test.yml?query=branch:v0.0.9
